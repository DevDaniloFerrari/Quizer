...
export default function Autenticacao() {
    ...
    const MainComponent = () => {
        if (renderizaLogin) {
            return <Login mudarComponenteAutenticacao={mudarComponenteAutenticacao} />
        }

        return <Cadastro mudarComponenteAutenticacao={mudarComponenteAutenticacao} />
    }

    return (
        <Layout selecionado={'autenticacao'}>
            <div className={`flex flex-row items-center justify-center h-screen font`}>
